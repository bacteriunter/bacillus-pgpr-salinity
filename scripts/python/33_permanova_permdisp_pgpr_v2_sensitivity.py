...
infile = "05_pgpr_matrix/pgpr_matrix_with_metadata_v2_sensitivity.tsv"

outdir = Path("06_statistics/v2_sensitivity")
outdir.mkdir(parents=True, exist_ok=True)

out_permanova = outdir / "permanova_jaccard_pgpr_v2_sensitivity.tsv"
out_permdisp = outdir / "permdisp_jaccard_pgpr_v2_sensitivity.tsv"
